...
После того как вы заполнили файл `.env` и настроили базу данных, можно запустить проект.

### 🐍 Локальный запуск

Выполните стандартные команды миграции и запуска сервера разработки:
