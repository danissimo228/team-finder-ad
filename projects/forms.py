...
class ProjectForm(forms.ModelForm):
    ...
    def clean_name(self):
        ...
        if len(name) > 200:
            raise forms.ValidationError('Название проекта не должно превышать 200 символов')
        return name
    ...
    def clean_github_url(self):
        ...
        if url and not url.startswith('https://github.com/'):
            raise forms.ValidationError('Введите корректную ссылку на GitHub репозиторий')
        return url